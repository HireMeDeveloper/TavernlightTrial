...
SpellInfo = {
  ['Default'] = {
    ['Ice Nado'] =                 {id = 300, words = 'frigo',                 exhaustion = 10,    premium = false, type = 'Instant', icon = 'eternalwinter',          mana = 0,      level = 1,  soul = 0, group = {[1] = 2000},               vocations = {1, 2, 3, 4, 5, 6, 7, 8}},
